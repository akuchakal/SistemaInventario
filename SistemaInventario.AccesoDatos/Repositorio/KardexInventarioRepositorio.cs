...
namespace SistemaInventario.AccesoDatos.Repositorio
{
    public class KardexInventarioRepositorio : Repositorio<KardexInventario>, IKardexInventarioRepositorio
    {
        ...
        public async Task RegistrarKArdex(int bodegaProductoId, string tipo, string detalle, int stockAterior, int cantidad, string usuarioId)
        {
            ...
            if (tipo == "Entrada")
            {
                ...
                kardex.StockAnterior = stockAterior;
                kardex.Cantidad = cantidad;
                kardex.Costo = bodegaProducto.Producto.Costo;
                kardex.Stock = stockAterior + cantidad;
